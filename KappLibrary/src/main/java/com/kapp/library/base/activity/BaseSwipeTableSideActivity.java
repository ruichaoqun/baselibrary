 ...
 *
 * 右边A~Z，中文排序效果（具体使用方式请参考FriendsListActivity）
 */

public abstract class BaseSwipeTableSideActivity<T> extends BaseSwipeActivity implements  BaseRecyclerAdapter.OnItemClickListener, BaseRecyclerAdapter.OnItemLongClickListener{
    ...
    public void bindSideView(int resourcesId, int showDialogId){
        bindSideView((SideBar) findViewById(resourcesId), (TextView) findViewById(showDialogId));
    }
