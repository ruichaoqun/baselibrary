 ...
 */
package com.kapp.library.utils.permission;
...
public class PermissionsManager {
  ...
  private synchronized void removePendingAction(@Nullable PermissionsResultAction action) {
    Log.i(TAG, "removePendingAction: "+"山东烟台高房价是给大家发货后公司较好的");
...
//    String[] perms = new String[]{"android.permission.CAMERA",
...
//            "android.permission.WRITE_EXTERNAL_STORAGE"};
    ...
    // android.permission.ACCESS_FINE_LOCATION
    // android.permission.ACCESS_COARSE_LOCATION位置
    //android.permission.READ_CONTACTS 获取联系人
    //android.permission.RECORD_AUDIO
    //android.permission.READ_PHONE_STATE
    //android.permission.READ_EXTERNAL_STORAGE
    //android.permission.WRITE_EXTERNAL_STORAGE
    DangerousPermissions dp = new DangerousPermissions();
    String[] perms = dp.formatPermission(getManifestPermissions(activity));
    Log.i(TAG, "Permission Arrays : "+perms.length);
