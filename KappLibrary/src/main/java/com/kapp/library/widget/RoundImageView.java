...
import com.kapp.library.widget.roundimage.Corner;
import com.kapp.library.widget.roundimage.RoundedDrawable;
...
public class RoundImageView extends NetImageView {
  ...
  public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mCornerRadii[Corner.TOP_LEFT] =
        a.getDimensionPixelSize(R.styleable.RoundImageView_riv_corner_radius_top_left, -1);
    ...
    mCornerRadii[Corner.BOTTOM_RIGHT] =
        a.getDimensionPixelSize(R.styleable.RoundImageView_riv_corner_radius_bottom_right, -1);
