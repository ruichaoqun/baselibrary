...
public class SideBar extends View {
	...
	public static int dialogColor[] = { R.mipmap.dialog_color_blue, R.mipmap.dialog_color_green,
			R.mipmap.dialog_color_orange, R.mipmap.dialog_color_purple, R.mipmap.dialog_color_red };;
			...
			if (oldChoose != c) {
				if (c >= 0 && c < b.length) {
					...
					if (mTextDialog != null) {
						...
						mTextDialog.setBackgroundResource(dialogColor[c / 6]);
					}
