package com.kapp.library.widget.wheel.easy;
 ...
 */
public class EasyPickerView<T extends BaseEasyPickerInfo> extends View {
        ...
        if (null != dataList && dataList.size() > 0) {
            ...
            for (int i = -half; i <= half; i++) {
                ...
                if (index >= 0 && index < size) {
                    ...
                    String text = dataList.get(index).getEasyPickerValue();
    ...
    public void setDataList(List<T> dataList) {
        ...
        if (null != dataList && dataList.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                float tempWidth = textPaint.measureText(dataList.get(i).getEasyPickerValue());
