package com.kapp.library.widget.wheel;
...
import com.kapp.library.widget.timepicker.utils.IPickerViewData;
import com.kapp.library.widget.timepicker.utils.OnItemSelectedListener;
import com.kapp.library.widget.wheel.adapter.WheelAdapter;
import com.kapp.library.widget.wheel.lib.InertiaTimerTask;
import com.kapp.library.widget.wheel.lib.LoopViewGestureListener;
import com.kapp.library.widget.wheel.lib.MessageHandler;
import com.kapp.library.widget.wheel.lib.OnItemSelectedRunnable;
import com.kapp.library.widget.wheel.lib.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    // 条目间距倍数
    static final float lineSpacingMultiplier = /*1.4F*/2.2F;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = ContextCompat.getColor(getContext(), R.color.pickerview_wheelview_textcolor_out);
        textColorCenter = ContextCompat.getColor(getContext(), R.color.pickerview_wheelview_textcolor_center);
        dividerColor = ContextCompat.getColor(getContext(), R.color.pickerview_wheelview_textcolor_divider);
