...
import com.kapp.library.widget.imagepicker.bean.ImageSet;
import com.kapp.library.widget.imagepicker.data.DataSource;
import com.kapp.library.widget.imagepicker.data.OnImagesLoadedListener;
import com.kapp.library.widget.imagepicker.data.impl.LocalDataSource;
import com.kapp.library.widget.imagepicker.ui.activity.ImageCropActivity;
import com.kapp.library.widget.imagepicker.widget.SuperCheckBox;
...
public class ImagesGridFragment extends Fragment implements OnImagesLoadedListener,AndroidImagePicker.OnImageSelectedChangeListener,AndroidImagePicker.OnImageCropCompleteListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageGridSize = (screenWidth - Util.dp2px(mContext, 2) * 2) / 3;
